...
- The fixture-backed scenarios are tagged `live` and use the shared `basic` and `enhanced` fixtures to validate existing-cluster compatibility checks against real OCI infrastructure.
