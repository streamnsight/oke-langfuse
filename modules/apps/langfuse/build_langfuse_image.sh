...
docker build -t ${REGION}.ocir.io/${TENANCY_NAMESPACE}/langfuse:${LANGFUSE_IMAGE_VERSION} --platform "linux/amd64" --build-arg NEXT_PUBLIC_BASE_PATH=/langfuse -f ./web/Dockerfile .
